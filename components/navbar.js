const Nav = () => {
    return  (
        <div className="flex justify-evenly p-5">
            <img className="max-h-9" src="/unflip.png" alt="logo" />
            ...
            <div className="flex">
                <button className="invisible md:visible rounded-lg text-black px-3 py-1 border border-gray-400 hover:bg-gray-100 mr-4">
                    Sign Up
                </button>
                <button className="invisible md:visible flex rounded-lg px-3 py-1 bg-black text-white">
